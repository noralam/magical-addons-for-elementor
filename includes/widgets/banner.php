...
use mgGlobalButton;
	...
	protected function register_style_controls() {
        ...
        $this->add_control(
			'mg_cta_image_height',
			[
				'label' => esc_html__( 'Image Height', 'magical-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .mg-cta.style-two .mg-cta-content figure img' => 'height: {{SIZE}}{{UNIT}}; !important',
				],
			]
		);
                ...
                <div class="mg-banner-sub">
                    ...
                    if ( $mg_cta_title && $mg_banner_title_show) :
                        printf( '<%1$s %2$s>%3$s %4$s</%1$s>',
                            ...
                            mg_kses_tags($mg_cta_title),'<span>'.wp_kses_post( $mg_cta_highlight ).'</span>' );
                    endif;
                    ?>
